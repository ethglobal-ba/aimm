...
export function useGetMarketQuery(
  baseOptions: Apollo.QueryHookOptions<Types.GetMarketQuery, Types.GetMarketQueryVariables> &
    ({ variables: Types.GetMarketQueryVariables; skip?: boolean } | { skip: boolean })
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useGetMarketLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<Types.GetMarketQuery, Types.GetMarketQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useGetMarketSuspenseQuery(
  baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetMarketQuery, Types.GetMarketQueryVariables>
) {
  const options = baseOptions === Apollo.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions };
